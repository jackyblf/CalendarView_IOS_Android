...
public class CalendarView extends View implements View.OnTouchListener {
    ...
    private int mDayNormalCellFontColor = Color.rgb(0,223,223);
    private int mDayNormalCellColor = Color.rgb(245,245,245);
    private int mDayNormalCellCircleColor = Color.rgb(230,230,230);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for(int i = begin - 1; i >= 0; i--)
        {
            ...
            drawCircleInRect(canvas,mTempRC,mDayNormalCellColor);
